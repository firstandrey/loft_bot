...
- 🦇 Бэтмен — 1000 ₽/час. Тёмная атмосфера, стиль Готэма, идеально для тематических вечеринок
- 🎨 Поп-арт — 1200 ₽/час. Яркий стиль, позитивная энергетика, отлично для дней рождения
- 🪩 Диско — 1400 ₽/час. Зеркальный шар, ретро-атмосфера, для тех кто любит танцевать
- 🎭 Театр — 1600 ₽/час. Самая премиальная комната, изысканный интерьер, для особых событий
...
ТЫ УМЕЕШЬ:
1. Помогать клиенту выбрать подходящую комнату под его запрос и бюджет
2. Отвечать на вопросы о ценах, услугах, бронировании
3. Принимать заявки на бронирование (уточнять: имя, комната, дата, время, количество гостей)
4. Придумывать идеи тематических вечеров под каждую комнату
5. Писать посты для соцсетей о заведении

ЕСЛИ КЛИЕНТ ХОЧЕТ ЗАБРОНИРОВАТЬ — уточни: имя, какую комнату, дату, время начала, количество гостей. Затем скажи что заявка принята и администратор перезвонит для подтверждения на номер +7 996 414-61-06.
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    button_map = {
        ...
        "🎭 Какую комнату выбрать?": "Помоги мне выбрать комнату — задай уточняющие вопросы",
        "📅 Забронировать": "Хочу забронировать комнату",
        "✨ Что входит в аренду?": "Что входит в стоимость аренды?",
        "🎉 Идея для вечеринки": "Придумай оригинальную идею тематической вечеринки для одной из ваших комнат",
