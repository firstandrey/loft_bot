...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    button_map = {
        ...
        "Идея для вечеринки": "Придумай идею тематической вечеринки для одной из комнат",
    ...
    try:
        ...
        await update.message.reply_text("Упс, что-то пошло не так. Попробуйте ещё раз через минуту.")
